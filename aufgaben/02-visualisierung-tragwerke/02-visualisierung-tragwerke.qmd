...
Zunächst verwenden wir für alle Stäbe eine einheitliche Dehnsteifigkeit. Dies lässt sich später einfach erweitern.

Das Tragwerk erzeugen wir in einer Funktion, die in einer eigenen Datei abgelegt werden soll. Das erleichtert später die Arbeit.
