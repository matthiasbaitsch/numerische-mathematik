...
$$
  ...
  \end{pmatrix}.
$$
Untersuchen Sie die Genauigkeit der Verfahren in der Datei `genauigkeit.mlx`:
...
Erzeugen Sie eine Datei `stabilitaet.mlx` und bearbeiten Sie folgende Punkte:
...
Der Verlauf der Lösungen soll für $0 \leq t \leq 40$ und unterschiedliche Werte von $\alpha$ untersucht werden. Bearbeiten Sie hierzu folgende Punkte (Datei \datei{startwerte.mlx}):
